...
import { StateHistoryData, useEvaStateHistory } from "@eva-ics/webengine-react";
...
const ChartDisplay = ({
    ...
    switch (kind) {
        ...
        case ChartKind.Radar:
            return <Radar datasetIdKey={datasetIdKey} data={data} options={options} />;
        case ChartKind.Doughnut:
            return <Doughnut datasetIdKey={datasetIdKey} data={data} options={options} />;
    }
};
...
const Chart = ({
    ...
    if (current_state.data) {
        ...
        return (
            <div style={chart_style} className={`eva chart loading ${className}`}></div>
        );
    }
};
